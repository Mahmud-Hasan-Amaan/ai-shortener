export const features = [
  {
    ...
    text: "Our AI generates creative, memorable short links that match your brand and style. No more random strings of characters - get links that make sense.",
    button: {
  ...
  },
  {
    ...
    text: "Get real-time analytics including click tracking, geolocation data, device information, and AI-powered audience insights to understand your link performance.",
    button: {
